...
<div class="fieldcontain ${hasErrors(bean: alunoInstance, field: 'tipoIngresso', 'error')} ">
	<label for="tipoIngresso">
		<g:message code="aluno.tipoIngresso.label" default="Tipo Ingresso" />
		
	</label>
	<g:textField name="tipoIngresso" value="${alunoInstance?.tipoIngresso}"/>

</div>

<div class="fieldcontain ${hasErrors(bean: alunoInstance, field: 'periodoIngresso', 'error')} ">
	<label for="periodoIngresso">
		<g:message code="aluno.periodoIngresso.label" default="Periodo Ingresso" />
		
	</label>
	<g:textField name="periodoIngresso" value="${alunoInstance?.periodoIngresso}"/>

</div>

<div class="fieldcontain ${hasErrors(bean: alunoInstance, field: 'turno', 'error')} ">
	<label for="turno">
		<g:message code="aluno.turno.label" default="Turno" />
		
	</label>
	<g:textField name="turno" value="${alunoInstance?.turno}"/>
